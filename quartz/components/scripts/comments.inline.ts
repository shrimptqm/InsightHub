...
document.addEventListener("DOMContentLoaded", () => {
  ...
  newScript.setAttribute('data-repo', 'shrimptqm/InsightHub');
  newScript.setAttribute('data-repo-id', 'R_kgDOMbs5mA');
  newScript.setAttribute('data-category', 'Announcements');
  newScript.setAttribute('data-category-id', 'DIC_kwDOMbs5mM4ChNq4');
